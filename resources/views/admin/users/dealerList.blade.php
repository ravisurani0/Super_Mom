@extends('layouts.app', ['page_title'=>'Dealers'])
            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Dealer List
                    </div>
                    <!-- <div class="card-toolbar">
                        <a href="{{ route('users.create') }}" class="btn btn-sm btn-primary font-weight-bolder btn-sm"><i class="fa fa-plus"></i>New Dealer</a>
                    </div> -->
                </div>
                <div class="card-body">
                    <!-- <div class="row mb-3">
        ...
        var table = $('.data-table').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    class: 'text-center',
                    "render": function(data, type, row, meta) {
                        return row.is_block ? "Blocked" : 'Active'
                    }
                },
                {
                    data: 'action',
