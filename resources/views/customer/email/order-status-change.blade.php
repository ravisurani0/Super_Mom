...
<body>
    <table
        ...
        <td colspan="3"
            ...
            Your order {{ $order->id }} has shipped!</td>
        <tr>
        </tr>
        <tr>
            <td colspan="3"
        ...
        <tr>
            <td style="vertical-align: bottom;">
                <p style="display: table;margin-top: 10px; auto 20px;">
                    <a href="{{ route('front.home') }}"
                        style="color:#0b5ed7; font-size: 14px;font-weight: bold;text-decoration: none;display: table-cell;vertical-align: middle;line-height: 100%;padding-left: 3px;">Track your order</a>
                </p>
            </td>
        </tr>
        <tr>
